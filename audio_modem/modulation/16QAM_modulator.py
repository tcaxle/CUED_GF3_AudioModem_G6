...
def mapping(bit_string,const_length=4):
    """
    Takes:
    ...
    """
    const_map = {
        "0000": complex(-3, -3)/np.sqrt(10),
        "0001": complex(-3, -1)/np.sqrt(10),
        "0010": complex(-3, +3)/np.sqrt(10),
        "0011": complex(-3, +1)/np.sqrt(10),
        "0100": complex(-1, -3)/np.sqrt(10),
        "0101": complex(-1, -1)/np.sqrt(10),
        "0110": complex(-1, +1)/np.sqrt(10),
        "0111": complex(-1, +1)/np.sqrt(10),
        "1000": complex(+3, -3)/np.sqrt(10),
        "1001": complex(+3, -1)/np.sqrt(10),
        "1010": complex(+3, +3)/np.sqrt(10),
        "1011": complex(+3, +1)/np.sqrt(10),
        "1100": complex(+1, -3)/np.sqrt(10),
        "1101": complex(+1, -1)/np.sqrt(10),
        "1110": complex(+1, +3)/np.sqrt(10),
        "1111": complex(+1, +1)/np.sqrt(10)
    }
